...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">INTRESTS LIST</h1>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel">Add Intrest</h4>
        ...
        <span>Description : </span><input type="text" name="des" class = "form-control" />
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM intrest ORDER BY intrest_name");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>
                            <tr class="record">
                                <td><?php echo $row['intrest_name']; ?></td>
                                <td><?php echo $row['intrest_description']; ?></td>
                                
                                <td><a rel="facebox" class="btn btn-primary" href="editevent.php?id=<?php echo $row['intrset_id']; ?>"> 
                                    <i class = "fa fa-pencil"></i>
                                </a>  
                                <a href="#" id="<?php echo $row['intrest_id']; ?>" class="btn btn-danger delbutton" title="Click To Delete">
