...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Hobbies List</h1>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="savehobbies.php" method="post" class = "form-group">
                                        <div id="ac">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM hobby ORDER BY hobby_name");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>
                            <tr class="record">
                                <td><?php echo $row['hobby_name']; ?></td>
                                <td><?php echo $row['hobby_description']; ?></td>
                             
                                <td><a rel="facebox" class="btn btn-primary" href="edithobbies.php?id=<?php echo $row['hobby_id']; ?>"> 
                                    <i class = "fa fa-pencil"></i>
                                </a>  
                                <a href="#" id="<?php echo $row['hobby_id']; ?>" class="btn btn-danger delbutton" title="Click To Delete">
