		...
		<div class="card" style="width: 400px; border:solid; border-width: 1px;  border-radius: 10px;">
			<div class="card-body">
				<ul class="nav nav-tabs" style="float: left;">
					<li class="active"><a data-toggle="pill" href="#login" style="font-size: 18pt; padding-left: 60px; padding-right: 60px; color: #337ab7;"><strong>Login</strong></a></li>
					<li><a data-toggle="pill" href="#signUp" style="font-size: 18pt; padding-left: 41px; padding-right:30px; color:#198754;"><strong>Sign Up!</strong></a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div id="signUp" class="tab-pane fade">
						<form method="POST" action="membershipPayment.php" style="padding-top: 80px; margin-left: 25px; margin-right: 25px" enctype="multipart/form-data">
							...
							<div class="form-group">
								<hr>
								<label style="margin-left: 85px">Personality Description</label>

								<p style="margin-left: 45px; margin-bottom: 10px;">Visit to link, to check your personality</p>


								<a class="btn btn-success" style="margin-left: 118px;" href="https://www.16personalities.com/free-personality-test" target="_blank" role="button">Take Test!</a>
								<hr>
