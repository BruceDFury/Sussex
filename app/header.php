  ...
  <div class="row bg-dark" style="margin-top: -15px;">
    <div class="col-sm-12" style="text-align: right;">
      ...
      if ((isset($_SESSION['first_name']) && !empty($_SESSION['first_name']))) {
        ...
        echo '<li class="nav-item btn btn-success">
        <a class="nav-link" href="login.php" style="font-size: 15pt; margin-top:15px">Login/Sign up</a>
        </li>';
      }
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <a class="nav-link" href="dashboard.php">Dashboard</a>
          ...
          echo '<li class="nav-item">
        <a class="nav-link" href="countdown.php">Membership Expire</a>
        </li>';
        }
        ?>
      </ul>
