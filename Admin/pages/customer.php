                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="savecustomer.php" method="post" class = "form-group">
                                        <div id="ac">
                                            <span>First Name : </span><input type="text" name="fname" required="" class = "form-control" />
                                            <span>Middle Name : </span><input type="text" name="mname" required="" class = "form-control" />
                                            <span>Last Name : </span><input type="text" name="lname" required="" class = "form-control" />
