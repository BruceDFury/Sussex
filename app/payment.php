...
if (isset($_POST['checkout'])) 
{
	...
	$_SESSION['edate'] = $_POST['event_date'];
	$_SESSION['orderno'] = $_POST['orderno'];
	$_SESSION['total'] = $_POST['total'];

	$query= "SELECT * FROM payments WHERE (email='$email') AND (event='$event') AND (edate='$edate') AND (status='valid')";
...
$query = "INSERT INTO payments (nic,orderno,email,phone,amount,event,edate) VALUES ('$nic','$orderno','$email','$phone','$total','$event','$edate')";
